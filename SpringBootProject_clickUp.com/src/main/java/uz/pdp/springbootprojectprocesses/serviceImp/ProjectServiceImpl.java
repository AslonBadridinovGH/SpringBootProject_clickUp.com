...
import uz.pdp.springbootprojectprocesses.repository.ProjectUserRepository;
import uz.pdp.springbootprojectprocesses.repository.SpaceRepository;
import uz.pdp.springbootprojectprocesses.repository.WorkspaceUserRepository;
...
public class ProjectServiceImpl implements ProjectService {
    ...
    public ApiResponse editFolder(ProjectDto projectDto, UUID id) {
        ...
        project.setArchived(projectDto.isArchived());
        projectRepository.save(project);
        return new ApiResponse("Project was edited",true);
    }
